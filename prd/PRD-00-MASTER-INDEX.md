...
| [PRD-10](PRD-10-DATA-OBSERVABILITY.md) | Events, artifacts, telemetry, recovery | Active; interaction SSE, exact durable run-event metadata, and both run-event WebSockets have bounded replay/reconnect evidence, while trace/context injection, best-effort deltas, audit/telemetry, retention, and operator recovery remain. |
