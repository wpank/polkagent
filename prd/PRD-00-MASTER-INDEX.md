...
| [PRD-10](PRD-10-DATA-OBSERVABILITY.md) | Events, artifacts, telemetry, recovery | Active; interaction SSE and both run-event WebSockets recover bounded in-session lag, while command-socket reconnect, best-effort deltas, audit/telemetry, retention, and operator recovery remain. |
