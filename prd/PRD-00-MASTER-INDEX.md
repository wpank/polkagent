...
| [PRD-10](PRD-10-DATA-OBSERVABILITY.md) | Events, artifacts, telemetry, recovery | Active; interaction SSE and the run-event API WebSocket have checkpointed replay/lag recovery, while best-effort deltas, the distinct command socket, audit/telemetry, retention, and operator recovery remain. |
