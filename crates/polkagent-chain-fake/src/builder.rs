...
pub const POLKADOT_GENESIS: [u8; 32] = [
    0x91, 0xb1, 0x71, 0xbb, 0x15, 0x8e, 0x2d, 0x38,
    0x48, 0xfa, 0x23, 0xa9, 0x7b, 0x64, 0x48, 0x77,
    0x58, 0x08, 0x55, 0x00, 0x7d, 0x04, 0x47, 0x87,
    0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
];

/// Kusama genesis hash (leading bytes of the real hash for test use).
pub const KUSAMA_GENESIS: [u8; 32] = [
    0xb0, 0xa8, 0xd4, 0x93, 0x28, 0x5c, 0x2d, 0xf7,
    0x32, 0x90, 0xdf, 0xb7, 0xe6, 0x1f, 0x87, 0x0f,
    0x17, 0xb4, 0x18, 0x01, 0x19, 0x7a, 0x14, 0x9c,
    0xa9, 0x36, 0x54, 0x99, 0x9e, 0xbc, 0xae, 0x88,
];
...
impl FakeChainClientBuilder {
    ...
    pub fn polkadot() -> Self {
        Self::new("polkadot").with_genesis_hash(POLKADOT_GENESIS).with_runtime_version(1_003_000, 0)
    }

    /// Use the Kusama defaults.
    #[must_use]
    pub fn kusama() -> Self {
        Self::new("kusama").with_genesis_hash(KUSAMA_GENESIS).with_runtime_version(1_003_000, 0)
    }
