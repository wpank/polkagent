...
mod tests {
    ...
    const POLKADOT_GENESIS: [u8; 32] = [
        0x91, 0xb1, 0x71, 0xbb, 0x15, 0x8e, 0x2d, 0x38, 0x48, 0xfa, 0x23, 0xa9, 0x7b, 0x72, 0x73,
        0x68, 0x35, 0x37, 0x22, 0x04, 0xd7, 0x60, 0x89, 0x29, 0x33, 0x91, 0x05, 0xf7, 0xf3, 0x74,
        0x58, 0x23,
    ];

    const KUSAMA_GENESIS: [u8; 32] = [
        0xb0, 0xa8, 0xd4, 0x93, 0x28, 0x5c, 0x2d, 0xf7, 0x32, 0x90, 0xdf, 0xb7, 0xe6, 0x1f, 0x87,
        0x0f, 0x17, 0xb4, 0x18, 0x01, 0x19, 0x7a, 0x14, 0x9c, 0xa9, 0x36, 0x54, 0x99, 0xea, 0x3d,
        0xaf, 0xe2,
    ];
    ...
    fn mismatched_genesis_returns_wrong_network_error() {
        ...
        assert!(
            ...
            "error should mention chain name: {msg}"
        );
    }
